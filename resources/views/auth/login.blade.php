...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Lavishly+Yours&family=Libre+Baskerville:ital,wght@0,400;0,700;1,400&family=Stack+Sans+Notch:wght@200..700&display=swap"
        rel="stylesheet">
...
<body class="bg-gray-50 min-h-screen">
    <div class="min-h-screen flex">
        <div
            class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-pink-50 to-purple-50 items-center justify-center p-12 relative overflow-hidden">
            <img src="images/login.jpg" alt="Background" class="absolute inset-0 w-full h-full object-cover">
