...
@section('styles')
    <style>
        ...
        .btn-action-group {
            display: flex;
            gap: 12px; /* Dibuat 12px agar konsisten dgn halaman lain */
            align-items: center;
        }
        ...
        /* Add Button - Gradient Primary (Biru Konsisten) */
        .btn-add {
        ...
        .btn-custom:hover i { transform: scale(1.2) rotate(5deg); }
        .btn-import:hover i { animation: slideUp 0.5s ease; }
        .btn-export:hover:not(:disabled) i { animation: slideDown 0.5s ease; }
        .btn-add:hover i { animation: rotate360 0.6s ease; }
        ...
        /* Responsive */
        @media (max-width: 992px) { /* Ubah breakpoint ke lg */
            .btn-action-group {
...
@section('content')
    ...
    <div class="card shadow-sm fade-in">
        <div class="card-header bg-white py-3">
            {{-- BUNGKUS SEMUA FILTER DALAM SATU FORM DENGAN ID --}}
            <form method="GET" action="{{ route('responden.index') }}" id="filterForm">
                <div class="row align-items-center g-3">
                        ...
                        <div class="d-flex flex-wrap flex-lg-nowrap gap-2">
                            ...
                            <div class="search-wrapper flex-grow-1" style="min-width: 250px;">
                                <input type="text" name="search" id="searchInput" class="form-control"
                                    placeholder="Cari nama, kec, desa, nks..."
                                    value="{{ request('search') }}">
                                <i class="bi bi-search search-icon"></i>

                                {{-- Tombol Clear (muncul jika ada filter aktif) --}}
                                @if (request('search') || request('year') || request('semester'))
                                <a href="{{ route('responden.index') }}" class="btn-clear-search"
                            ...
                            {{-- Tombol Submit Filter (Dihidden, auto-submit via JS) --}}
                            <button type="submit" class="btn-filter-submit d-none" data-bs-toggle="tooltip" title="Terapkan Filter">
                    ...
                    <div class="col-lg-5 col-md-12">
                        <div class="btn-action-group justify-content-lg-end">
                            ...
                            <a href="{{ route('responden.create') }}" class="btn btn-custom btn-add" data-bs-toggle="tooltip"
                    ...
                    <tbody>
                        @forelse ($data as $row)
                            <tr class="fade-in">
                                ...
                                <td>
                                    {{-- Ikon 'fa fa-medium' dari kode asli Anda tetap dipertahankan --}}
                                ...
                                <td>
                                    <small class="text-muted">{{ $row->created_at ? $row->created_at->format('d/m/Y') : '-' }}</small>
                                </td>
                                <td class="text-center">
                        ...
                        @empty
                            <tr>
                                ...
                                <td colspan="11" class="text-center py-5 fade-in" style="animation-delay: 0.1s;">
                                    <i class="bi bi-inbox" style="font-size: 3rem; color: #ccc;"></i>
                                    
                                    @if(request('search') || request('year') || request('semester'))
                                        <p class="text-muted mt-2">Tidak ada data yang cocok dengan filter Anda.</p>
                                        <a href="{{ route('responden.index') }}" class="btn btn-primary btn-sm">
                    ...
                    <div class="modal-body">
                        <div class="alert alert-warning border-warning system-info-item">
                            ...
                            <ol class="mb-0 small">
                                ...
                                <li class="mb-2">
                                    <strong>nama_sample:</strong> Nama responden usia 15+ (minimal 3 karakter, hanya huruf &
                                    spasi).<br>
                                    <code>Contoh: Budi Santoso, Siti Nurhaliza</code>
                                    <br><span class="text-danger">⚠️ Nama tidak boleh aneh atau hanya angka!</span>
                                </li>
                                <li class="mb-2">
                                    <strong>r7_1 sampai r20_4:</strong> Kolom jawaban responden (opsional).<br>
                            ...
                            <div class="alert alert-info mt-3 mb-0">
                                <small>
                                    ...
                                    • Pastikan isian jawaban sesuai alur pengisian<br>
