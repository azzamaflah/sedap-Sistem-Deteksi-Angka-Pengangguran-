...
@section('styles')
    <style>
        ...
        .btn-custom {
            position: relative;
            /* overflow: hidden; <- Dihapus untuk memastikan badge tidak terpotong */
            font-weight: 600;
        ...
        .export-counter {
            /* **PENYESUAIAN Z-INDEX DAN POSISI AGAR TERLIHAT JELAS** */
            position: absolute;
            top: -10px;
            right: -10px;
            background: #dc3545;
                ...
                <div class="col-lg-5 col-md-12">
                    <form method="GET" class="search-wrapper">
                        ...
                        <input type="text" name="search" id="searchInput" class="form-control"
                            placeholder="Cari nama responden atau lokasi..." value="{{ request('search') }}">

                        @if (request('search'))
                            <a href="{{ route('responden.index') }}" class="btn-clear-search" data-bs-toggle="tooltip"
